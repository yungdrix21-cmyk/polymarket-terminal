...
function DepositsPage({ user, onDepositSuccess, kycStatus }) {
  ...
  { symbol: 'USDT', name: 'Tether', logo: 'https://assets.coingecko.com/coins/images/325/large/Tether.png', address: 'TSNWcBSsete8aKgYFSfhc7VPetc85u8zi3', color: '#26a17b', network: 'TRC-20' },
