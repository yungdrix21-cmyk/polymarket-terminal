  ...
  const handleAccountStep = async () => {
    ...
    try {
      ...
      if (err) {
        ...
        } else if (err.message.toLowerCase().includes('rate') || err.message.toLowerCase().includes('limit') || err.message.toLowerCase().includes('exceeded') || err.message.toLowerCase().includes('email rate')) {
